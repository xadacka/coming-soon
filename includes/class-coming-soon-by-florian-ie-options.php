...
class Coming_Soon_By_Florian_IE_Options {
    ...
    public function page_init() {
        ...
        add_settings_field(
            ...
            array( $this, 'send_503_status_callback' ),
            'csbf-setting-admin',
            'csbf_setting_section'
        );
    }
    ...
    public function send_503_status_callback() {
        printf(
            '<input type="checkbox" id="send_503_status" name="csbf_options[send_503_status]" value="1" %s />',
            isset( $this->options['send_503_status'] ) && $this->options['send_503_status'] == 1 ? 'checked' : ''
        );
        echo '<p class="description">When enabled, the coming soon page will return a 503 HTTP status code. This is recommended for SEO as it tells search engines the site is temporarily unavailable. Disable this if you\'re experiencing issues with your hosting setup.</p>';
    }
} 